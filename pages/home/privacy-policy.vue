<template>
  <div class="agreement-container">
    TruBrush Privacy Policy <br><br>

    This Privacy Policy describes how your personal information is collected, used,
    and shared when you visit or make a purchase from
    <a>www.itrubrush.com</a>
    (the “Site”). <br><br>
    ...
    information as “Order Information.”<br><br>
    ...
    advertising relating to our products or services.<br><br>

    We use the Device Information that we collect to help us screen for potential risk and fraud
    (in particular, your IP address), and more generally to improve and optimize our Site
    (for example, by generating analytics about how our customers browse and interact with the Site,
    and to assess the success of our marketing and advertising campaigns).<br><br>
    ...
    as described above. For example, we also use Google Analytics to help us understand how our
    customers use the Site--you can read more about how Google uses your Personal Information
    here:<a>https://www.google.com/intl/en/policies/privacy/</a> .
    You can also opt-out of Google Analytics here: <a href="">https://tools.google.com/dlpage/gaoptout</a>.
    We also use Oribi to help us understand how our customers use the Site--you can read more
    about how Oribi uses your Personal Information here:<a href="">https://oribi.io/privacy</a>.<br><br>
    ...
    information we receive, or to otherwise protect our rights.<br><br>
    ...
    educational page at
    <a href="">http://www.networkadvertising.org/understanding-online-advertising/how-does-it-work</a>.<br><br>

    You can opt out of targeted advertising by visiting pages of the companies below:<br>
    FACEBOOK -<a href="">https://www.facebook.com/settings/?tab=ads</a> <br>
    GOOGLE -<a href="">https://www.google.com/settings/ads/anonymous</a> <br>
    BING -<a href="">https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads</a> <br><br>

    Additionally, you can opt out of some of these services by visiting the Digital Advertising
    Alliance’s opt-out portal at: <a href="">http://optout.aboutads.info/</a>.<br><br>

    DO NOT TRACK<br>
    Please note that we do not alter our Site’s data collection and use practices when we see a
    Do Not Track signal from your browser.<br><br>

    YOUR RIGHTS<br>
    If you are a European resident, you have the right to access personal information we hold about
    you and to ask that your personal information be corrected, updated, or deleted. If you would
    like to exercise this right, please contact us through the contact information below.<br><br>
    ...
    including to Canada and the United States.<br><br>

    DATA RETENTION<br>
    When you place an order through the Site, we will maintain your Order Information
    for our records unless and until you ask us to delete this information.<br><br>
    ...
    <a href="">support@trubrush.com</a>
    or by mail using the details provided below:<br><br>

    300 Delaware Avenue, Suite 210-A, Wilmington, DE, 19801, United States<br><br>
